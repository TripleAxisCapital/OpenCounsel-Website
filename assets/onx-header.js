...
class ONXHeader extends HTMLElement {
  constructor() {
    ...
    // Gate: ignore bogus initial scroll on mobile until user interacts
    this._armed = false;
  ...
  connectedCallback() {
    ...
    this._root.innerHTML = `
      <style>
        ...
        .g-grad,.grad-anim{background:linear-gradient(var(--angle,135deg),var(--grad-from),var(--grad-via),var(--grad-to));background-size:300% 300%;animation:gradientShift var(--speed,16s) ease-in-out infinite;}
        .text-grad{background:linear-gradient(var(--angle,135deg),var(--grad-from),var(--grad-via),var(--grad-to));background-size:300% 300%;animation:gradientShift var(--speed,16s) ease-in-out infinite;-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent;}
        ...
        .oc-header{background:transparent;padding-top:var(--header-flat-pad-top);padding-bottom:var(--header-flat-pad-bottom);transition:padding .36s cubic-bezier(.2,.8,.2,1);}
        .header-bar{
          position:relative;box-sizing:border-box;width:var(--header-width-flat);margin-inline:auto;
          display:flex;align-items:center;justify-content:space-between;
          height:var(--pill-height-mobile);
          padding-left:var(--pill-inner-x-mobile);padding-right:var(--pill-inner-x-mobile);
          background:transparent;border:0;border-radius:0;box-shadow:none;line-height:1;
          -webkit-backdrop-filter:none;backdrop-filter:none;
          transition:width .36s cubic-bezier(.2,.8,.2,1),background-color .36s ease,border-radius .36s cubic-bezier(.2,.8,.2,1),box-shadow .36s ease,-webkit-backdrop-filter .36s ease,backdrop-filter .36s ease;
        }

        .logo-pad{height:100%;padding-left:var(--logo-pad-left-mobile);display:flex;align-items:center;gap:.75rem;}
        ...
        .center .nav-link:not(.nav-link--black){background:linear-gradient(var(--angle,135deg),var(--grad-from),var(--grad-via),var(--grad-to));background-size:300% 300%;animation:gradientShift var(--speed,16s) ease-in-out infinite;-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent;padding-bottom:.06em;}
        ...
        :host(.is-float) .oc-header{padding-top:var(--header-float-pad-top-mobile);padding-bottom:var(--header-float-pad-bottom-mobile);}
        @media (min-width:768px){
          :host(.is-float) .oc-header{padding-top:var(--header-float-pad-top-desktop);padding-bottom:var(--header-float-pad-bottom-desktop);}
        }
        :host(.is-float) .header-bar{
          background:rgba(255,255,255,.96);border:1px solid rgba(0,0,0,0.02);border-radius:var(--header-radius);
        ...
        @media (min-width:768px){
          :host(.is-float) .header-bar{width:min(var(--header-max-w),calc(100% - (2 * var(--pill-outer-x-desktop))));}
        }

        .nav-link{font-weight:var(--nav-font-weight);letter-spacing:var(--nav-letter-spacing);font-size:var(--nav-font-size);line-height:var(--nav-line-height);display:inline-block;position:relative;transition:transform .2s cubic-bezier(.2,.8,.2,1);}
        ...
        .center .nav-link::after{content:"";position:absolute;left:10%;right:10%;bottom:-.28em;height:2px;background:currentColor;opacity:.22;transform:scaleX(0);transform-origin:50% 50%;transition:transform .28s ease,opacity .28s ease;}
        ...
        .btn{display:inline-flex;align-items:center;gap:.5rem;color:#fff;font-size:.9rem;font-weight:700;border-radius:16px;padding:.55rem 1rem;box-shadow:0 18px 30px rgba(0,0,0,.18);transition:transform .2s ease,box-shadow .2s ease;box-sizing:border-box;}
        ...
        @media (min-width:768px){
          .desktop-actions .btn{height:calc(var(--pill-height-desktop) - (2 * var(--download-btn-pad-y-desktop)));padding-block:var(--download-btn-pad-y-desktop);}
          .news-link{display:inline-flex;}
        }

        /* Mobile UI */
        .hamburger{--hb-size:clamp(40px,6vw,48px);--hb-line:2px;--hb-w:calc(var(--hb-size)*.56);--hb-h:calc(var(--hb-size)*.38);--hb-color:#0A0D10;display:inline-flex;align-items:center;justify-content:center;width:var(--hb-size);height:var(--hb-size);background:transparent;border:none;border-radius:12px;padding:0;color:var(--hb-color);transition:transform .16s ease,background-color .16s ease;-webkit-tap-highlight-color:transparent;touch-action:manipulation;}
        ...
        .hamburger .lines::before,.hamburger .lines::after,.hamburger .lines span{content:"";position:absolute;left:0;right:0;height:var(--hb-line);border-radius:1.5px;background:currentColor;transform-origin:50% 50%;transition:transform .22s cubic-bezier(.2,.8,.2,1),opacity .18s ease;}
        ...
        .sheet{position:fixed;top:max(12px, env(safe-area-inset-top));left:max(12px, env(safe-area-inset-left));right:max(12px, env(safe-area-inset-right));margin-bottom:max(12px, env(safe-area-inset-bottom));background:rgba(255,255,255,.98);border-radius:22px;border:1px solid rgba(0,0,0,.06);box-shadow:0 18px 40px rgba(0,0,0,.2);opacity:0;pointer-events:none;transition:opacity .18s ease;-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);display:flex;flex-direction:column;max-height:calc(100dvh - 24px - env(safe-area-inset-top) - env(safe-area-inset-bottom));overflow:clip;contain:paint;z-index:2147483647;}
        ...
        .mobile-link{display:flex;align-items:center;justify-content:space-between;padding:var(--mobile-link-padding);border-radius:14px;color:#0A0D10;font-weight:var(--nav-font-weight);font-size:var(--nav-font-size);letter-spacing:var(--nav-letter-spacing);line-height:var(--nav-line-height);transition:background-color .18s ease,transform .18s ease;}
        ...
        .mobile-extra-actions a,.mobile-extra-actions button{position:static!important;float:none!important;display:inline-flex!important;align-items:center;justify-content:center;width:100%!important;max-width:100%!important;margin:0!important;inset:auto!important;box-sizing:border-box!important;border-radius:14px!important;padding:.75rem 1rem!important;text-align:center!important;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}

        .sheet .hamburger,.sheet .hamburger:hover,.sheet .hamburger:active,.sheet .hamburger:focus,.sheet .hamburger:focus-visible{background:transparent!important;box-shadow:none!important;outline:none!important;transform:none!important;}

        /* ONXPro themes (unchanged) */
        ...
        :host([theme="onxpro"]) .center .nav-link,
        :host([theme="pro"]) .center .nav-link{background:none!important;-webkit-text-fill-color:initial!important;color:#fff!important;padding-bottom:0!important;}
        ...
        :host([theme="onxpro"]) .mobile-actions .btn,
        :host([theme="pro"]) .mobile-actions .btn{background:#fff!important;color:#0A0D10!important;animation:none!important;}
        :host([theme="ONXPro"]) .hamburger,
        :host([theme="onxpro"]) .hamburger,
        :host([theme="pro"]) .hamburger{color:#fff;}

        @media (prefers-reduced-motion: reduce){
          .sheet,.backdrop,.hamburger .lines::before,.hamburger .lines::after,.hamburger .lines span{transition:none;}
        }
        ...
        :host([theme="pro-light"]) .header-bar{background:#fff!important;color:#0A0D10!important;border:none!important;box-shadow:none!important;border-radius:var(--header-radius);-webkit-backdrop-filter:none!important;backdrop-filter:none!important;}
        :host([invert].is-float) .header-bar,
        :host([theme="ONXProLight"].is-float) .header-bar,
        :host([theme="onxpro-light"].is-float) .header-bar,
        :host([theme="pro-light"].is-float) .header-bar{background:#fff!important;border:none!important;box-shadow:none!important;}
        ...
        :host([theme="pro-light"]) .center .nav-link{background:none!important;-webkit-text-fill-color:initial!important;color:#0A0D10!important;padding-bottom:0!important;}
        ...
        :host([theme="pro-light"]) .mobile-actions .btn{background:#0A0D10!important;color:#fff!important;animation:none!important;}
        ...
        :host([theme="pro-light"]) .logo-anim{background:#000!important;animation:none!important;}

        /* ── FORCE FLAT (must override pill until user scrolls) ── */
        :host(.force-flat) .oc-header{
          padding-top: var(--header-flat-pad-top) !important;
          padding-bottom: var(--header-flat-pad-bottom) !important;
        }
        :host(.force-flat) .header-bar{
          ...
          width: var(--header-width-flat) !important; /* full width */
        }
      </style>
    ...
    window.addEventListener("pageshow", (e) => {
      // BFCache restore can come back scrolled; respect that but keep flat if not armed
      if (!this._isMobile()) return this._onScroll();
      if (!this._armed && (window.scrollY || 0) <= this._threshold) {
        this.classList.add("force-flat");
        this.classList.remove("is-float");
      }
      this._onScroll();
    }, { passive: true });

    // arm when there is real user intent (prevents false initial pill)
    window.addEventListener("touchstart", this._arm, { passive: true });
    window.addEventListener("pointerdown", this._arm, { passive: true });
    window.addEventListener("wheel", this._arm, { passive: true });
    ...
    // Initial: mobile large; desktop normal
    if (this._isMobile()) {
      this.classList.add("force-flat");
      this.classList.remove("is-float");
    } else {
      this.classList.remove("force-flat");
    }
  ...
  disconnectedCallback() {
    ...
    window.removeEventListener("wheel", this._arm);
  ...
  _arm() {
    ...
    this._armed = true;
    // Re-evaluate immediately after first real interaction
    this._onScroll();
  }
  ...
  _renderExtraLinks(list = []) {
    ...
    list.forEach(item => {
      ...
      a.href = item.href; a.textContent = item.label; centerExtra.appendChild(a);
      const m = document.createElement('a');
      m.className = 'mobile-link' + (item.pro ? ' mobile-link--pro' : '');
      m.href = item.href; m.textContent = item.label;
  ...
  _onResize(){
    ...
    // On breakpoint/orientation changes, re-evaluate
    if (this._isMobile()) {
      if (!this._armed && (window.scrollY || 0) <= this._threshold) {
        this.classList.add("force-flat");
        this.classList.remove("is-float");
  ...
  _onScroll() {
    ...
    if (this._isMobile()) {
      // If the user hasn't interacted yet, **force flat** and ignore tiny initial scroll jitter
      if (!this._armed && y <= this._threshold) {
        this.classList.add("force-flat");
        this.classList.remove("is-float");
        return;
      }
      // After first real interaction or if genuinely scrolled
      if (y > this._threshold) {
        this.classList.remove("force-flat");
        this.classList.add("is-float");
      } else {
        this.classList.add("force-flat");
        this.classList.remove("is-float");
      }
